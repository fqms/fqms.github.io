...
allIn.links = {
  sourceforge: {
    windows: 'https://sourceforge.net/projects/free-queue-manager/files/0.9/FQM_win_09.zip/download',
    linux: 'https://sourceforge.net/projects/free-queue-manager/files/0.9/FQM_linux_09.zip/download',
    macos: 'https://sourceforge.net/projects/free-queue-manager/files/0.9/FQM_mac_09.zip/download'
  },
  github: {
    windows: 'https://github.com/mrf345/FQM/releases/download/0.9/FQM_win_09.zip',
    linux: 'https://github.com/mrf345/FQM/releases/download/0.9/FQM_linux_09.zip',
    macos: 'https://github.com/mrf345/FQM/releases/download/0.9/FQM_mac_09.zip'
  }
}
